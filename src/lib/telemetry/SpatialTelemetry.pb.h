...
#define SpatialTelemetry_init_default            {0, 0, 0, 0, 0, 0, 0}
#define SpatialTelemetry_init_zero               {0, 0, 0, 0, 0, 0, 0}
...
#define SpatialTelemetry_current_tag             7
...
#define SpatialTelemetry_size                    53
